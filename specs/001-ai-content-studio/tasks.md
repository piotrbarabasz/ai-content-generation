...
Test requirements: Add basic unit coverage later in Phase 10 for enum and type behavior.
Parallelizable: yes
...
Test requirements: Add model validation tests later in Phase 10.
Parallelizable: no
...
Files to create or modify: `backend/app/workflow/module.py`, `backend/app/workflow/registry.py`, `backend/app/workflow/execution.py`
...
Test requirements: Add registry and execution-plan tests later in Phase 10.
Parallelizable: no
...
Files to create or modify: `backend/app/workflow/engine.py`
Dependencies: T007
...
Test requirements: Add engine order and missing-dependency tests later in Phase 10.
Parallelizable: no
...
Files to create or modify: `backend/app/storage/artifact_store.py`, `backend/app/storage/local_store.py`, `backend/app/storage/manifest.py`, `backend/app/domain/workflow_run.py`, `backend/app/domain/generation_job.py`
Dependencies: T006
...
Test requirements: Add artifact-store tests later in Phase 10.
Parallelizable: no
...
Test requirements: Add mock provider tests later in Phase 10.
Parallelizable: no
...
Files to create or modify: `backend/app/modules/brief.py`
...
Test requirements: Add module-behavior tests later in Phase 10.
Parallelizable: no
...
Files to create or modify: `backend/app/modules/voiceover.py`
...
Test requirements: Add output-artifact and failed-module tests later in Phase 10.
Parallelizable: no
...
Files to create or modify: `backend/app/workflow/presets.py`, `backend/app/workflow/registry.py`
...
Files to create or modify: `backend/app/api/main.py`, `backend/app/api/schemas.py`, `backend/app/api/dependencies.py`
...
Files to create or modify: `backend/app/api/routes/projects.py`, `backend/app/api/routes/workflow_configs.py`, `backend/app/api/routes/workflow_runs.py`, `backend/app/api/routes/artifacts.py`
...
Files to create or modify: `backend/app/domain/approval.py`
...
Files to create or modify: `backend/tests/unit/test_module_registry.py`, `backend/tests/unit/test_workflow_engine.py`
...
Files to create or modify: `backend/tests/unit/test_artifact_store.py`, `backend/tests/unit/test_mock_providers.py`
...
Files to create or modify: `backend/tests/unit/test_presets.py`, `backend/tests/integration/test_api_smoke.py`
...
Files to create or modify: `docs/migration/shorts-repo-migration-plan.md`, `docs/migration/long-form-repo-migration-plan.md`
...
Files to create or modify: `backend/app/providers/registry.py`, `backend/app/providers/interfaces.py`, `backend/app/providers/mocks.py`
...
Files to create or modify: `backend/app/providers/validation.py`, `backend/app/workflow/engine.py`, `backend/app/domain/workflow_config.py`
...
Files to create or modify: `backend/app/modules/script_generation.py`
...
Files to create or modify: `backend/app/modules/scene_planning.py`
...
Files to create or modify: `backend/app/modules/captions.py`
...
Files to create or modify: `backend/app/modules/video_rendering.py`
...
Files to create or modify: `backend/app/domain/export_bundle.py`, `backend/app/modules/export_manifest.py`
...
Files to create or modify: `backend/app/modules/export.py`
...
Files to create or modify: `backend/app/modules/research.py`
...
Files to create or modify: `backend/app/modules/dossier.py`
Dependencies: T031
...
Files to create or modify: `backend/app/modules/outline.py`
...
Files to create or modify: `backend/app/modules/post_processing.py`
...
Files to create or modify: `backend/app/modules/qa.py`
Dependencies: T034
...
Files to create or modify: `backend/app/workflow/presets.py`
...
Files to create or modify: `backend/app/workflow/engine.py`, `backend/app/workflow/execution.py`
...
Files to create or modify: `backend/app/api/routes/approvals.py`, `backend/app/api/routes/workflow_runs.py`, `backend/app/api/main.py`
...
Files to create or modify: `backend/app/workflow/usage.py`, `backend/app/workflow/execution.py`
Dependencies: T007, T008
...
Files to create or modify: `backend/tests/unit/test_provider_registry.py`, `backend/tests/unit/test_provider_validation.py`, `backend/tests/unit/test_workflow_config_validation.py`
...
Files to create or modify: `backend/tests/unit/test_approval_workflow.py`, `backend/tests/integration/test_approval_api.py`
...
Files to create or modify: `backend/tests/unit/test_export_manifest.py`, `backend/tests/integration/test_export_bundle.py`
...
Files to create or modify: `backend/tests/integration/test_long_form_workflow.py`
...
Files to create or modify: `backend/tests/unit/test_retry_behavior.py`, `backend/tests/unit/test_failed_module_handling.py`, `backend/tests/static/test_secret_hygiene.py`
