        ...
        *,
        ...
        return "\n".join(
            [
                ...
                "Task ownership and closure rules:",
                "The outer TaskPipeline owns persistent task closure.",
                "Do not run spec_closer.",
                "Do not modify tasks.md.",
                "Do not change any checkbox in tasks.md.",
                "Perform implementation, targeted validation, and review only.",
                "Stop after reviewer PASS / SAFE_TO_CLOSE.",
                "The outer TaskPipeline will run the finalizer, close the checkbox, and commit.",
                "Do not add tasks.md to files_touched.",
                "files_touched must contain only implementation and test files that were actually changed.",
