> Historical source-repository analysis. This describes an earlier repository or migration proposal, not current product requirements. See docs/architecture/overview.md and docs/ROADMAP.md for current behavior and work.
